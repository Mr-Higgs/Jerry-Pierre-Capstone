            ...
            <div className="row">
                <div className="col">
                    <div className="card m-4" style={{width: "18rem"}}>
                        ...
                        <div className="card-body">
                            <h5 className="card-title">Wolf of Forex: Bundle </h5>
                ...
                <div className="col">
                    <div className="card m-4" style={{width: "18rem"}}>
                        ...
                        <div className="card-body">
                            <h5 className="card-title">Wolf of Forex: Technical Starter Pack </h5>
                            <p className="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                            <a href="#" className="btn btn-success">Enroll</a>
                        </div>
                    </div>
                ...
                <div className="col">
                    <div className="card m-4" style={{width: "18rem"}}>
                        ...
                        <div className="card-body">
                            <h5 className="card-title">Wolf of Forex: Learn to Earn Discord</h5>
